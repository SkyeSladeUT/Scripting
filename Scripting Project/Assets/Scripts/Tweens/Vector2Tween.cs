...
public class Vector2Tween : TweenFunctions<Vector2>
{
    public Vector2Tween()
    {
    ...
    public Vector2Tween(System.Action<ITween<Vector2>> updateFunc, System.Action<ITween<Vector2>> completeFunc)
    {
        updateFunction = updateFunc;
        completeFunction = completeFunc;
    }

    public System.Action<ITween<Vector2>> updateFunction { get; set; }
    public System.Action<ITween<Vector2>> completeFunction { get; set; }

    protected override void RunCubicFunction(GameObject obj, Vector2 InitValue, Vector2 FinalValue, float duration, EaseFunctions easeFunction)
    {
        switch (easeFunction)
        {
    ...
    protected override void RunLinearFunction(GameObject obj, Vector2 InitValue, Vector2 FinalValue, float duration)
    {
        obj.Tween(obj.name + "Float", InitValue, FinalValue, duration, TweenScaleFunctions.Linear, updateFunction, completeFunction);
    }


    protected override void RunQuadraticFunction(GameObject obj, Vector2 InitValue, Vector2 FinalValue, float duration, EaseFunctions easeFunction)
    {
        switch (easeFunction)
        {
            case EaseFunctions.EaseIn:
    ...
    protected override void RunQuarticFunction(GameObject obj, Vector2 InitValue, Vector2 FinalValue, float duration, EaseFunctions easeFunction)
    {
        switch (easeFunction)
        {
            case EaseFunctions.EaseIn:
    ...
    protected override void RunQuinticFunction(GameObject obj, Vector2 InitValue, Vector2 FinalValue, float duration, EaseFunctions easeFunction)
    {
        switch (easeFunction)
        {
            case EaseFunctions.EaseIn:
    ...
    protected override void RunSineFunction(GameObject obj, Vector2 InitValue, Vector2 FinalValue, float duration, EaseFunctions easeFunction)
    {
        switch (easeFunction)
        {
            case EaseFunctions.EaseIn:

    ...
    public class DialogueController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            foreach (var conv in _dialogues.conversations)
            {
                ...
                {
                    if (line.LineType == LineTypes.Script)
                    {
                        try
                        {
        ...
        public void StartConversation(string conversationName)
        {
            ...
            {
                inConv = true;
                Conversation conversation = _dialogues[conversationName];
        ...
        private IEnumerator RunDialogue(Line line)
        {
            //Scroll Dialogue
        ...
        private IEnumerator RunChoice(Line line)
        {
            //Give Choices
        ...
        private IEnumerator RunAnimation(Line line)
        {
            GameObject character;
            if (_characterObjects.TryGetValue(line.CharacterName, out character))
            {
        ...
        private IEnumerator RunScript(Line line)
        {
            Action lineAction;
        ...
        private IEnumerator RunAudio(Line line)
        {
            GameObject character;
            if (_characterObjects.TryGetValue(line.CharacterName, out character))
            {

...
namespace GameManagement
{
    ...
    public class OptionsMenu
    {
        ...
        public OptionsMenu(FullMenu manager)
        {
            ...
            _volumeSlider.value = _manager.Manager.GDManager.Data.options.MainVolume;
            ...
            _musicSlider.value = _manager.Manager.GDManager.Data.options.MusicVolume;
            ...
            _sfxSlider.value = _manager.Manager.GDManager.Data.options.SFXVolume;
            ...
            _dialogueSlider.value = _manager.Manager.GDManager.Data.options.DialogueVolume;
            ...
            _dialogueSpeedSlider.value = _manager.Manager.GDManager.Data.options.DialogueSpeed;
            ...
            _cameraSensitivitySlider.value = _manager.Manager.GDManager.Data.options.CameraSensitivity;

        }

        public void OnVolumeSliderChange(float val)
        {
            _manager.Manager.GDManager.Data.options.MainVolume = val;
        }
        public void OnMusicSliderChange(float val)
        {
            _manager.Manager.GDManager.Data.options.MusicVolume = val;
        }
        public void OnSFXSliderChange(float val)
        {
            _manager.Manager.GDManager.Data.options.SFXVolume = val;
        }
        public void OnDialogueSliderChange(float val)
        {
            _manager.Manager.GDManager.Data.options.DialogueVolume = val;
        }
        public void OnDialogueSpeedChange(float val)
        {
            _manager.Manager.GDManager.Data.options.DialogueSpeed = val;
        }
        public void OnCameraSensitivityChange(float val)
        {
            _manager.Manager.GDManager.Data.options.CameraSensitivity = val;
        }
        public void Open()
        {
    ...
    public class InventoryMenu
    {
        ...
        public void Open()
        {
            ...
            items = _manager.Manager.GDManager.LoadInventory().GetItems();
